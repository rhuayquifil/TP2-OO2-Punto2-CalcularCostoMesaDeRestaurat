...
//
//		try {
//			assertEquals(814.8, miMesa.calcularCostoDeMesa(miTarjeta, 5));  // solo con bebidas
//			
...
//
//		try {
//			assertEquals(908.46, miMesa.calcularCostoDeMesa(miTarjeta, 3)); // solo con plato
//
...
//
//		try {
//			assertEquals(1699.32, miMesa.calcularCostoDeMesa(miTarjeta, 2)); // con bebidas y plato
//		} catch (NumberFormatException e) {
//			fail("exceptions NumberFormatException");
//		}
//	}
...
//		listaConsumisionesPedido.add(new Item(milanesa, 1));
		...
		try {
			assertEquals(840, miMesa.calcularCostoDeMesa(miTarjeta, 5)); // con bebidas y plato
		} catch (NumberFormatException e) {
			fail("exceptions NumberFormatException");
		}
	}
